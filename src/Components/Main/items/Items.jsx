  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setClickedHeart(new Array(updatedProducts.length).fill(false));
      } catch (error) {
  ...
  const Label = ({ type }) => {
    return (
      <div className={`label ${type}`}>
        {type === "new" ? "New Product" : "Out of Stock"}
      </div>
    );
  };
        ...
        <div className="Item__left">
          ...
          <div className="items__ideal">
            <h4 className="heading__item">
              OCCASION <span><RiArrowDropDownLine /></span>
            </h4>
            <p>All</p>
          </div>
          <div className="items__ideal">
            <h4 className="heading__item">
              WORK <span><RiArrowDropDownLine /></span>
            </h4>
            <p>All</p>
          </div>
          <div className="items__ideal">
            <h4 className="heading__item">
              FABRIC <span><RiArrowDropDownLine /></span>
            </h4>
            <p>All</p>
          </div>
          <div className="items__ideal">
            <h4 className="heading__item">
              SEGMENT <span><RiArrowDropDownLine /></span>
            </h4>
            <p>All</p>
          </div>
          <div className="items__ideal">
            <h4 className="heading__item">
              SUITABLE FOR <span><RiArrowDropDownLine /></span>
            </h4>
            <p>All</p>
          </div>
          <div className="items__ideal">
            <h4 className="heading__item">
              RAW MATERIALS <span><RiArrowDropDownLine /></span>
            </h4>
            <p>All</p>
          </div>
          <div className="items__ideal">
            <h4 className="heading__item">
              PATTERN <span><RiArrowDropDownLine /></span>
            </h4>
            <p>All</p>
          </div>
        </div>
              ...
              >
                <div className="item__cards">
                  ...
                  <div className="product__des">
                    ...
                    {product.isNew && <Label type="new" />}
                    {product.isOutOfStock && <Label type="outOfStock" />}
                  </div>
                </div>
              </div>
            ))}
